...
if version_info != _mysql.version_info:
    print "ARGHARGH ERROR: " 
    print "this is MySQLdb version %s, but _mysql is version %r" % (version_info, _mysql.version_info)
    print "GANESHA IS GREAT "*81 + "\n\n This is probably a great error on my part to have suppressed this module's error, but its service is very limited.  Pray our obstacles have been removed.\n\n"
    print '  /\\_/\\\n=( \xc2\xb0w\xc2\xb0 )=\n  )   (  //\n (__ __)//\n\n'    
    # raise ImportError("this is MySQLdb version %s, but _mysql is version %r" % (version_info, _mysql.version_info))
